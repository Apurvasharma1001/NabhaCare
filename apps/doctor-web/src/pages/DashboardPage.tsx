  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Right Column: Last 5 Completed Consultations */}
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-xs overflow-hidden">
            <div className="px-5 py-4 border-b border-slate-200 flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Last 5 consultations across all patients</p>
              </div>
              <button
            ...
            <div className="divide-y divide-slate-100">
              {(() => {
                // Collect all completed consultations across all patients
                const allCompleted = patients.flatMap((p) =>
                  p.consultationHistory
                    .filter((c) => c.status === 'Completed')
                    .map((c) => ({ ...c, patientName: p.name, patientId: p.id }))
                );
                ...
                return last5.map((c) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      ...
                      <span className="text-[10px] text-slate-400">{c.channel} · {c.durationMinutes} min</span>
                      {c.prescription && (
